...
public class Mov411Action implements ActionInterface, Constants{
	...
	private void registra(HttpServletRequest request, HttpServletResponse response) {
		...
		if("b1".equals(action)){
			...
			pagDest= URL.MOV_411;
			System.err.println("[411] JAVA - LICHA: "+request.getAttribute("LICHA") + "CHARG: "+request.getAttribute("CHARG"));
		}
