...
public class Mov581Action implements ActionInterface, Constants{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(URL.MOV_581.equals(pagProv)){

			ricercaEconferma(request, response);
		}else if(URL.MOV_RIEPILOGO581.equals(pagProv)){
			riepilogoAction(request, response);
		}else if(URL.DETTAGLIO_MOV581.equals(pagProv)){
