		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form name="form" method="post" action="MainUrl">
					...
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.MOV_RICERCA_261 %>"/>
					<input type="hidden" name="<%=ZFMWM_GET_MOV_NETWORK.BWART %>" id="<%=ZFMWM_GET_MOV_NETWORK.BWART %>" value="261" />
					<div class="row">

						<div class="page-header">
							<h4 class="text-center text-primary"><b>Movimentazione 261</b></h4>
						</div>

						<div class="form-group col-md-12 col-sm-12 col-xs-12">
							<label for="<%=ZFMWM_GET_MOV_NETWORK.AUFNR %>">Numero OdP</label>
	    					<input type="text" class="form-control input-lg" placeholder="Numero OdP" id="<%=ZFMWM_GET_MOV_NETWORK.AUFNR %>" name="<%=ZFMWM_GET_MOV_NETWORK.AUFNR %>" maxlength="18" value="<%=I_AUFNR %>" required/>
						</div>
