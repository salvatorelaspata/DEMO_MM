	...
	<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form name="form" method="post" action="MainUrl" class="formCheckBatch" accept-charset="utf-8">

					<input type="hidden" name="host" id="host" value="<%=host %>"/>
					<input type="hidden" name="action" id="action" value=""/>
					<input type="hidden" name="pos" id="pos" value="<%=pos%>"/>
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.MOV_261 %>"/>
					<input type="hidden" id="<%=ZSWM_MOVIMENTAZIONI.BWART %>" name="<%=ZFMWM_GET_MOV_NETWORK.BWART %>" value="261"/>		
					<input type="hidden" name="<%=ZSWM_MOVIMENTAZIONI.AUFNR %>" value="<%=I_AUFNR %>"/>
					...
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12 col-xs-12">
							<label for="<%=IT_LISTA_NETWORK.POSID %>">WBS</label>
