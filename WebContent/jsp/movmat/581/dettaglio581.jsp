		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form name="form" method="post" action="MainUrl">
					...
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.DETTAGLIO_MOV581 %>"/>
					...
					<div class="row">
						...
						<div class="form-group col-md-3 col-sm-3 col-xs-3">
							<label>Tipo</label>
	    					<input type="text" class="form-control input-lg tipo" id="LGTYP" name="LGTYP" readonly placeholder="Tipo" value="<%=det.getLGTYP()%>" maxlength="3" required/>
						</div>
	
						<div class="form-group col-md-3 col-sm-3 col-xs-3">
							<label>Numero</label>
	    					<input type="text" class="form-control input-lg numero" id="LGNUM" name="LGNUM" readonly placeholder="Numero" value="<%=det.getLGNUM()%>" maxlength="3" required/>
						</div>
						<div class="form-group col-md-6 col-sm-6 col-xs-6">
							<label>Ubicazione</label>
	    					<input type="text" class="form-control input-lg ubicazione " id="LGPLA" name="LGPLA" readonly placeholder="Ubicazione" value="<%=det.getLGPLA()%>" required/>
						</div>

					</div>

					<p class="text-center">
						<button type="button" class="btn btn-lg btn-outline-secondary btn-block goBack" data-hidden="action" data-href="<%=URL.MOV_RIEPILOGO581%>">Indietro</button>
					</p>
