		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form name="form" method="post" action="MainUrl">
					...
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.MOV_RICERCA_101 %>"/>
					...
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12 col-xs-12">
							<label for="<%=ZFMWM_GET_ODA.I_EBELN %>">Numero OdA</label>
	    					<input type="text" class="form-control input-lg" placeholder="Numero OdA" id="<%=ZFMWM_GET_ODA.I_EBELN %>" name="<%=ZFMWM_GET_ODA.I_EBELN %>" maxlength="18" value="<%=I_EBELN %>" required/>
						</div>

						<div class="form-group col-md-12 col-sm-12 col-xs-12">
							<label for="<%=ZFMWM_GET_ODA.I_EBELP %>">Posizione</label>
	    					<input type="text" class="form-control input-lg" placeholder="Posizione" id="<%=ZFMWM_GET_ODA.I_EBELP %>" name="<%=ZFMWM_GET_ODA.I_EBELP %>" maxlength="4" value="<%=I_EBELP%>" required/>
						</div>
