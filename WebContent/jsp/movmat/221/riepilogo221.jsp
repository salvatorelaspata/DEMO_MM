		...
		<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				<div class="panel-body <%=panelBodyPaddingReset%>">
						...
						<input type="hidden" name="<%=Constants.PagProvenienza%>" id="<%=Constants.PagProvenienza%>"  value="<%=Constants.URL.MOV_RIEPILOGO221%>"/>
						<input type="hidden" id="<%=ZSWM_MOVIMENTAZIONI.BWART %>" name="<%=ZSWM_MOVIMENTAZIONI.BWART %>" value="221"/>		
					...
					<div class="row">
						<div class="page-header <%=headerMarginBottomReset%>">
							<h4 class="text-center text-primary"><b>Lista Movimentazione 221</b></h4>
						</div>
					</div>
					...
					%>
						<div class="row">
							<p class="text-center text-muted"> Nessuna Movimentazione 221 trovata.</p>
						</div>
					<%
					}
					%>
