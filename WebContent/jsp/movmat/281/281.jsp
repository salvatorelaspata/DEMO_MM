		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form name="form" method="post" action="MainUrl">
					...
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.MOV_281 %>"/>
					<input type="hidden" class="l10 span text" id="<%=ZSWM_MOVIMENTAZIONI.BWART %>" name="<%=ZSWM_MOVIMENTAZIONI.BWART %>" value="281"/>	
					 
					<div class="row">

						<div class="page-header">
							<h4 class="text-center text-primary"><b>Movimentazione 281</b></h4>
						</div>
