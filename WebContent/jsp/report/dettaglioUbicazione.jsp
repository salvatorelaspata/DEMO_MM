		...
		<div class="panel panel-default">
			<div class="panel-body <%=panelBodyPaddingReset%>">
				...
				<form name="form" method="post" action="MainUrl">
					...
					<input type="hidden" name="<%=Constants.PagProvenienza %>" id="<%=Constants.PagProvenienza %>"  value="<%=Constants.URL.DETTAGLIOUBICAZIONE %>"/>
				</form>

				<div class="row">
					<div class="page-header <%=headerMarginBottomReset%>">
						<h4 class="text-center text-primary"><b>Dettaglio Materiale</b></h4>
					</div>
					...
					<div class="form-group col-md-6 col-sm-6 col-xs-6">
						<label for="AUSME">Quantit&agrave;</label>
